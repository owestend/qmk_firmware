...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = TEMPLATE_75(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC2, KC_SPC1, KCSPC3,                    KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [_FNC] = TEMPLATE_75(\
        ...
        _______, KC_SEC1, KC_SEC2, KC_SEC3, KC_SEC4, KC_SEC5, KC_SEC6, KC_SEC7, KC_SEC8, KC_SEC9, KC_SEC0, _______, _______, _______,          _______,
        ...
        _______, _______, _______,                   KC_SPC2, KC_SPC1, KC_SPC3,                   _______, _______, _______, KC_HOME, KC_PGDN, KC_END),
    ...
    [_ADJ] = LAYOUT_75_ansi(\
        ...
        _______, _______, _______, _______, _______, KC_VRSN, _______, _______, KC_MAKE, _______, _______,          _______,          _______, _______,
        _______, _______, _______,                   KC_SPC2, KC_SPC1, KC_SPC3,                   _______, _______, _______, _______, _______, _______),
