...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = TEMPLATE_TKL(
        KC_ESC ,          KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  , KC_F6  , KC_F7  , KC_F8  , KC_F9  , KC_F10 , KC_F11 , KC_F12 ,   KC_PSCR, KC_PAUS, MO_ADJ ,
    ...
    [_NAV] = TEMPLATE(
        ...
        _______,          _______, _______, _______, MY_WBKW, _______, KC_DEL , _______, _______, _______, _______,          _______, _______,
    ...
    [_FNC] = TEMPLATE(
        ...
        _______, _______, _______,                   KC_SPC2, KC_SPC1, KC_SPC3,                   _______, _______, _______, _______),
